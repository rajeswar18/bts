...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if not args.multiprocessing_distributed or (
        ...
        if args.do_online_eval:
            ...
            #TODO: figure out where this is written
    ...
    while epoch < args.num_epochs:
        ...
        for step, sample_batched in enumerate(dataloader.data):
            ...
            if global_step and global_step % args.log_freq == 0 and not model_just_loaded:
                var_sum = [
                    var.sum() for var in model.parameters() if var.requires_grad
                ]
                var_cnt = len(var_sum)
                var_sum = np.sum(var_sum)
                ...
                if not args.multiprocessing_distributed or (
                    ...
                    wandb.log({
                        ...
                        'var average': var_sum.item() / var_cnt
                    })
...
model_dir = args.log_directory + '/' + args.model_name
...
if ngpus_per_node == 0:
    print("Running on CPU. Veeeeery slooooow.")
    ngpus_per_node = 1
...
if args.do_online_eval:
    ...
    print(
        "This will evaluate the model every eval_freq {} steps and save best models for individual eval metrics."
